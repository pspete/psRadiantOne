	...
	InModuleScope 'psRadiantOne' {
		...
		BeforeEach {
			...
			Mock Invoke-R1RestMethod -MockWith {
				[pscustomobject]@{
					'classname'      = 'globalIntercept'
					'filename'       = 'globalIntercept.java'
					'scriptContents' = 'public class GlobalIntercept { }'
				}
			}

			Set-R1GlobalInterceptionScript -scriptContents 'public class Replacement { }' -Confirm:$false
		...
		Context 'Input' {
			...
			It 'sends request to expected endpoint' {
				...
				Should -Invoke -CommandName Invoke-R1RestMethod -ParameterFilter {
					...
					($Method -eq 'PUT') -and ($URI -eq 'https://radiantone.company.com/directory-namespace-service/interception_scripts/global')
			...
			It 'sends the specified value' {
				...
				Should -Invoke -CommandName Invoke-R1RestMethod -ParameterFilter {
					...
					($Body | ConvertFrom-Json).scriptContents -eq 'public class Replacement { }'
			...
			It 'preserves properties which were not specified' {
				...
				Should -Invoke -CommandName Invoke-R1RestMethod -ParameterFilter {
					...
					($Decoded.classname -eq 'globalIntercept') -and ($Decoded.filename -eq 'globalIntercept.java')
