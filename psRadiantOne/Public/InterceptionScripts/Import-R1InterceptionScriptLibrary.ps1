...
function Import-R1InterceptionScriptLibrary {
	...
	Process {
		...
		$RequestPath = 'interception_scripts/libraries'
		...
		if ($PSCmdlet.ShouldProcess($File.Name, 'Upload Interception Script Library')) {
