...
## DESCRIPTION
Adds a content node beneath the naming context node identified by its DN, built from the given
relationship object.
...
[New-R1NamingContextContainer](New-R1NamingContextContainer)
