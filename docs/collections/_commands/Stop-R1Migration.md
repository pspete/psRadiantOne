...
## SYNOPSIS
Cancels the running migration operation.

## SYNTAX

```
Stop-R1Migration [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
Cancels whichever migration operation is running and returns the resulting status.
...
Cancels the running operation, after prompting for confirmation.
