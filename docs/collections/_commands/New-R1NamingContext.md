...
Unverified against a live deployment. The tenant available for testing has no configuration
beyond its default root, so this command has been built from the API definition alone.
